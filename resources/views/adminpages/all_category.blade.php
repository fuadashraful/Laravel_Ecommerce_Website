    ...
    <div class="table-responsive p-3">
        ...
        <tbody>
            ...
            @foreach($all_category as $data)
                ...
                @if($data->publication_status==0)
                <td><a class="text-success" href="{{URL::to('/admin/toggle_category_status/'.$data->category_id.'/'.$data->publication_status)}}" > Enable<i class="fa-2x fas fa-arrow-up"></i></a></td>
                @else
                <td><a class="text-danger" href="{{URL::to('/admin/toggle_category_status/'.$data->category_id.'/'.$data->publication_status)}}" >Disable <i class="fa-2x fas fa-arrow-down"></i></a></td>
                @endif
                <td> <a class="text-success"  href="{{URL::to('/admin/update_category/'.$data->category_id)}}"><i class="fa-2x fas fa-pen-alt"></i></a></td>
                <td><a class="text-danger" href="{{URL::to('/admin/delete_category/'.$data->category_id)}}"><i class="fa-2x fas fa-trash-alt"></a></i></td>
