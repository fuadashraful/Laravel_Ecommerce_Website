...
<div class="well well-small">
	...
	<?php
		...
		$categories=DB::table('category_tbl')->where('publication_status',1)->get();

		foreach ($categories as $category){?>

		<li><a href="products.html"><span class="icon-chevron-right"></span>{{$category->category_name}}</a></li>
		...
		<li> <a class="totalInCart" href="cart.html"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;">$448.42</span></strong></a></li>
			...
			<li>
			  <div class="thumbnail">
				...
				<img src="{{asset('frontend/assets/img/bootstrap-ecommerce-templates.png')}}" alt="bootstrap ecommerce templates">
				<div class="caption">
			...
			<li>
			  <div class="thumbnail">
				<a class="zoomTool" href="product_details.html" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<img src="{{asset('frontend/assets/img/shopping-cart-template.png')}}" alt="shopping cart template">
				<div class="caption">
				  <h4><a class="defaultBtn" href="product_details.html">VIEW</a> <span class="pull-right">$22.00</span></h4>
				</div>
			  </div>
